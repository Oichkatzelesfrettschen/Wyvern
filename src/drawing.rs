//! # Layer and Element Composition
//!
//! Composites the visible layers and elements for rendering.
//!
//! Organizes render elements into semantic layers:
//! - Background (desktop workspace)
//! - Tile/Grid (window tiling or layout)
//! - Floating (modals, popups, tooltips)
//! - Fullscreen (fullscreen window)
//! - Lock screen
//! - Cursor
//!
//! Provides functions to collect all visible elements in Z-order
//! and delegate rendering to the backend's renderer.
