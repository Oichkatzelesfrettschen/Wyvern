//! # Cursor Management
//!
//! Loads and manages cursor themes and animations.
//!
//! Uses XCursor theme format for cursor images and animations.
//! Respects `XCURSOR_THEME` and `XCURSOR_SIZE` environment variables.
//!
//! Provides animated cursor support for themes with multiple frames.
