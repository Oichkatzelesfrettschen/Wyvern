//! # Rendering Interface
//!
//! Abstract rendering interface and output management.
//!
//! Provides backend-agnostic rendering functions that:
//! - Manage output (display) configuration and damage tracking
//! - Render compositor elements to the framebuffer
//! - Handle frame callbacks and presentation feedback
//! - Support multiple texture import formats (EGL, dmabuf, SHM)
//!
//! ## Backend Abstraction
//!
//! Rendering is dispatched through trait objects, allowing
//! backends (udev, winit, x11) to provide their own renderer implementations
//! while the compositor core remains backend-agnostic.
