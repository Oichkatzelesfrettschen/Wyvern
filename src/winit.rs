...
//!
//! Desktop windowing backend for development and testing.
//!
//! Provides:
//! - Desktop window rendered in the host X11/Wayland environment
//! - GPU-accelerated rendering with GLES via EGL
//! - Keyboard and pointer input from the host
//! - Convenient development environment (restart without VT switch)
//!
...
pub fn run_winit(
    ...
    event_loop
        ...
        .insert_source(
            event_rx_main,
            move |event, _metadata, data: &mut WyvernState<WinitData>| {
