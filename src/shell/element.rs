//! # Window Rendering Elements
//!
//! Abstractions for rendering windows and their decorations.
//!
//! Provides:
//! - [`WindowRenderElement`]: Composite element for a window (surface + decorations)
//! - [`FullScreenRenderElement`]: Element for fullscreen windows
//! - Damage tracking for efficient incremental rendering
//! - Hit testing for pointer event routing
//!
//! Integrates with Smithay's render element system for compositing.
