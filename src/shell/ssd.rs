...
//!
//! Renders window decorations (title bar, borders) on behalf of clients.
//!
//! When XDG Shell's `server_side_decoration` is enabled, the compositor
//! renders decorations instead of the client. This module provides:
//! - Decoration rendering (title bar background, borders)
//! - Mouse event handling for window controls (close, minimize, maximize)
//! - Title text layout and rendering
//!
//! Server-side decorations improve:
//! - Visual consistency across applications
//! - Performance for simple window managers
//! - Accessibility for clients that don't render decorations
