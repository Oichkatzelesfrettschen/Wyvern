...
//!
//! Implements the XDG Shell protocol for modern Wayland window management.
//!
//! Handles:
//! - Toplevel windows (regular windows with decorations)
//! - Popup surfaces (tooltips, menus, dropdowns)
//! - Layer surfaces (taskbars, panels, notifications)
//! - Application menus and context menus
//!
//! Delegates to compositor for:
//! - Focus management (who gets keyboard input)
...
impl<BackendData: Backend> XdgShellHandler for WyvernState<BackendData> {
    ...
    fn new_toplevel(&mut self, surface: ToplevelSurface) {
        ...
        place_new_window(self, &window, true);
