//! # X11 Window Integration (XWayland)
//!
//! Integrates X11 applications via XWayland.
//!
//! XWayland is a Wayland server that implements X11 protocol,
//! allowing legacy X11 applications to run on Wayland.
//!
//! This module:
//! - Manages X11 surface windows (windows created by X11 clients)
//! - Translates X11 window events to Wayland semantics
//! - Handles window positioning, resizing, and focus
//! - Manages X11 window properties and decorations
//!
//! Only compiled with `feature = "xwayland"`.
